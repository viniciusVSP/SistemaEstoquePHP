...
<body>
  ...
  <!-- Begin Navbar -->
  <div id="nav">
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="250">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="inicio.php"><img class="img-thumbnail" src="../img/vinicius.png" alt="" width="200px" height="150px" margin-bottom="100px"></a>
        </div>
